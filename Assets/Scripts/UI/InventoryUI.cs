...
public class InventoryUI : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (sortModeText != null)
        {
            ...
            sortModeText.text = $"<color=#444444>\u21c5</color> <color=#88ddff><b>{SortModeNames[_currentSortMode]}</b></color>";
        }
    ...
    void CycleSortMode()
    {
        ...
        if (sortModeText != null) { sortModeText.color = Color.white; sortModeText.text = $"<color=#444444>\u21c5</color> <color=#88ddff><b>{SortModeNames[_currentSortMode]}</b></color>"; }
