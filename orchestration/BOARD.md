...
| # | 태스크 | 우선순위 | 상태 | 비고 |
|---|--------|---------|------|------|
| 1 | S-096 MonsterController 공격 범위 외 데미지 차단 | P3 | 👀 |  |
| 2 | S-097 SaveSystem 슬롯 삭제 확인 팝업 | P3 | 📋 |  |
| 3 | S-098 AchievementUI 알림 큐 중복 방지 | P3 | 📋 |  |
...
| S-096 MonsterController 공격 범위 외 데미지 차단 | 2026-04-04 | ⏳ |  |
