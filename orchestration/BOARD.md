...
| S-084 WorldEventSystem 종료 잔존 오브젝트 정리 | 2026-04-04 | ⏳ | P3 |
...
| 태스크 | 우선순위 | 비고 |
|--------|---------|------|
| S-085 NPC 대화 종료 직후 재진입 방지 | P3 | P3 |
| S-086 SkillBar 쿨다운 시각 동기화 | P3 | P3 |
| S-092 DialogueUI 긴 텍스트 오버플로 처리 | P3 | P3 |
| S-094 CraftingUI 재료 부족 항목별 표시 | P3 | P3 |
 P3 |
