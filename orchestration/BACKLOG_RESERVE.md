...
> **최종 갱신:** 2026-04-03 (Supervisor 동기화)
...
| 8 | S-043 | 🔧 | CombatManager 동시 사망 보상 — 동시에 여러 몬스터 사망 시 XP/골드 누적 정확성 검증 | P2 | ⬜ |
| 9 | S-044 | 🔧 | 장비 교체 시 스탯 복원 — 장비 해제/교체 시 이전 스탯 보너스 정확히 제거 확인 | P2 | ⬜ |
| 10 | S-045 | 🔧 | QuestSystem 진행률 저장 — 게임 종료/크래시 시 퀘스트 중간 진행 상태 보존 확인 | P2 | ⬜ |
| 11 | S-046 | 🔧 | MonsterSpawner 리전 전환 클린업 — 리전 전환 시 이전 리전 몬스터 오브젝트 정리 확인 | P2 | ⬜ |
| 12 | S-047 | 🔧 | DialogueSystem 동시 대화 방지 — 다중 NPC 동시 대화 시작 잠금 확인 | P2 | ⬜ |
| 13 | S-048 | 🔧 | SkillSystem 데이터 무결성 — skills.json 필드 누락/잘못된 타입 시 방어 로딩 | P2 | ⬜ |
| 14 | S-049 | 🔧 | ObjectPool 최대 크기 제한 — 풀 무한 성장 방지 (maxSize 상한 도입 검토) | P3 | ⬜ |
| 15 | S-050 | 🔧 | InputSystem UI/게임 입력 분리 — UI 패널 열린 상태에서 게임 입력 차단 확인 | P2 | ⬜ |
| 16 | S-051 | 🔧 | SceneTransition 메모리 누수 — 씬 전환 후 이전 씬 리소스 해제 확인 | P2 | ⬜ |
| 17 | S-052 | 🔧 | EventBus 이벤트 순서 안정성 — 동일 이벤트 다중 핸들러 실행 순서 보장 검증 | P3 | ⬜ |
| 18 | S-053 | 🔧 | PlayerController 벽 끼임 방지 — 콜라이더 경계에서 플레이어 위치 보정 확인 | P3 | ⬜ |
| 19 | S-054 | 🔧 | AutoSave 전투 중 저장 방지 — 전투 상태에서 자동 저장 스킵 (데이터 일관성) | P2 | ⬜ |
| 20 | S-055 | 🔧 | UI 해상도 대응 — 다양한 해상도에서 UI 앵커/레이아웃 정상 동작 검증 | P3 | ⬜ |
| 21 | S-056 | 🔧 | GameManager 초기화 순서 — Awake/Start 의존성 순서 보장 및 경합 확인 | P2 | ⬜ |
| 22 | S-057 | 🎨 | 스킬 아이콘 누락 점검 — skills.json 대비 스킬 아이콘 파일 교차검증 | P3 | ⬜ |
| 23 | S-058 | 🎨 | 몬스터 스프라이트 누락 점검 — monsters.json 대비 몬스터 스프라이트 교차검증 | P3 | ⬜ |
