...
> **최종 갱신:** 2026-04-03 (Supervisor 루프 #21)
...
| ID | 태스크 | 완료일 |
|----|--------|--------|
| S-005 | InventorySystem LINQ 할당 제거 — Where/ToList → 수동 루프 (SortItems, GetFiltered) + using Linq 제거 | 2026-04-03 |
| S-007 | CombatManager _cachedMonsters stale ref 방어 — _pendingKills 지연 처리로 foreach 중 리스트 변조 방지 | 2026-04-03 |
| S-010 | QuestSystem null 방어 강화 — CompleteQuest에서 def.rewards null 시 안전 기본값 반환 | 2026-04-03 |
